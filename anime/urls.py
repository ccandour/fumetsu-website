...
from .views import List, Anime_content, Anime_episode, redirect_legacy_anime, search_anime
...
urlpatterns = [
    ...
    path('anime/<anime_slug:anime_name>/<int:ep>/', Anime_episode.as_view(), name='ep-nm'),
