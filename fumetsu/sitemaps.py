...
from fumetsu.models import AnimeSeries, AnimeEpisode
...
class StaticViewSitemap(Sitemap):
    ...
    def items(self):
        return ["home", "anime-list", "fumetsu-about", "fumetsu-announcements", "fumetsu-privacy-policy", "fumetsu-terms-of-service"]
